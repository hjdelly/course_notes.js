const login = () => {                          //login function here ---const variable login stores the arrow function no args
  ...
  const updateAccount = () => {                //update account function ---variable updateAccount stores the arrow function no args
  ...
  async function loginActivities() {            // start with async(before function declaration) then say function loginActivities
